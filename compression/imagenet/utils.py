...
def risk(model, n, gpu_id=-1):
    batch_size = 32
    if os.name == 'nt':
        data = LabeledImageDatasetSubset("D:/codes/data/random_50000_with_label", subset=n)
    else:
        data = LabeledImageDatasetSubset("/data/leuven/326/vsc32665/random_50000_with_label", subset=n)
...
def f_norm(model, compressed_model, pick, n, gpu_id=-1):
    batch_size = 32
    if os.name == 'nt':
        data = ImageDatasetSubset("D:/codes/data/random_50000", subset=n)
    else:
        data = ImageDatasetSubset("/data/leuven/326/vsc32665/random_50000", subset=n)
